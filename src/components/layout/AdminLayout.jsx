...
import { LayoutDashboard, Users, Flag, Film, MessageSquare, Shield, Activity, ListVideo, MessageCircle, History } from 'lucide-react'
...
function AdminSidebar({ isOpen, isMobile, onClose }) {
    ...
    const navigation = [
        ...
        { name: 'User Activity', href: '/admin/user-activity', icon: History },
